...
public class MapsActivity extends FragmentActivity  implements GoogleMap.OnMapLongClickListener,LocationListener{
    ...
    double oldlatitude = 1000000;
    double oldLongtitude = 100000;
    ...
    public void onLocationChanged(Location location) {
        ...
        if(!(oldlatitude==1000000&&oldLongtitude==100000)) {

            mMap.addPolyline(new PolylineOptions().add(new LatLng(oldlatitude, oldLongtitude)).add(new LatLng(location.getLatitude(), location.getLongitude())));
        }
